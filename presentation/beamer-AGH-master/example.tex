...
\begin{frame}{Porównywane reprezentacje audio}
	...
	\vspace{0.5em}
	\begin{alertblock}{Uwaga metodologiczna}
		Nazwa ostatniego notebooka sugeruje MusicNN, ale implementacja używa checkpointu Cnn14 z PANNs: \texttt{Cnn14\_mAP=0.431.pth}.
	\end{alertblock}
\end{frame}
...
\begin{frame}{Zachowanie na poziomie gatunków}
	\begin{columns}
		\column{0.48\textwidth}
		\begin{block}{Najczęściej silniejsze klasy}
			\begin{itemize}
				\item Rock
				\item Hip-Hop
				\item Electronic
		...
		\column{0.48\textwidth}
		\begin{alertblock}{Najtrudniejsza klasa}
			\begin{itemize}
				\item Pop
			\end{itemize}
		\end{alertblock}
